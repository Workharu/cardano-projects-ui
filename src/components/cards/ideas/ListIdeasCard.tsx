...
export default function ListIdeasCard({ idea }: Props) {
  ...
  const { id, title = 'No Title', idea_number, description, kudo_count = 0, submitter_name = 'Unknown' } = idea;
        ...
        <Stack flex={1} spacing={1}>
          ...
          >
            <Typography
              ...
              dangerouslySetInnerHTML={{ __html: removeImagesAndTruncate(description) || '' }}
            />
          </Box>
          <Button
            startIcon={<Eye />}
