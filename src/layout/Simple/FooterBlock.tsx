                ...
                <Grid container spacing={2}>
                  ...
                  <Grid size={12}>
                    <Typography variant="subtitle1" sx={{ fontWeight: 400, maxWidth: 320 }}>
                      workharu has gained the trust of over 5.5K+ customers since 2015, thanks to our commitment to delivering high-quality
              ...
              <Grid container spacing={{ xs: 5, md: 2 }}>
                <Grid size={{ xs: 6, sm: 4 }}>
                  <Stack sx={{ gap: 3 }}>
                    ...
                    <Stack sx={{ gap: { xs: 1.5, md: 2.5 } }}>
                      ...
                      <FooterLink href="https://workharu.net" target="_blank" underline="none">
                        Website
                      </FooterLink>
                    </Stack>
                  </Stack>
                ...
                <Grid size={{ xs: 6, sm: 4 }}>
                  <Stack sx={{ gap: 3 }}>
                    ...
                    <Stack sx={{ gap: { xs: 1.5, md: 2.5 } }}>
                      <FooterLink href="https://workharu.gitbook.io/able-pro" target="_blank" underline="none">
                        Documentation
                      </FooterLink>
                      <FooterLink href="https://workharu.authordesk.app/" target="_blank" underline="none">
                        Feature Request
                      </FooterLink>
                      <FooterLink href="https://workharu.gitbook.io/able-pro/v/react/roadmap/" target="_blank" underline="none">
                        RoadMap
                      </FooterLink>
                      <FooterLink href="https://workharu.authordesk.app/" target="_blank" underline="none">
                        Support
                      </FooterLink>
                      <FooterLink href="https://themeforest.net/user/workharu#contact" target="_blank" underline="none">
                        Email Us
                      </FooterLink>
                    </Stack>
                  </Stack>
        ...
        <Container>
          <Grid container spacing={2} sx={{ alignItems: 'center' }}>
            <Grid size={{ xs: 12, sm: 8 }}>
              <Typography>
                © Handcrafted by Team{' '}
                <Link href="https://themeforest.net/user/workharu" target="_blank" underline="none">
                  {' '}
                  workharu
                </Link>
              </Typography>
              ...
              <Grid container spacing={2} sx={{ alignItems: 'center', justifyContent: 'flex-end' }}>
                <Grid>
                  <Tooltip title="Github">
                    <Link href="https://github.com/workharu" underline="none" target="_blank" sx={linkSX}>
                      <GithubIcon size={20} />
                    </Link>
                  </Tooltip>
                </Grid>
                <Grid>
                  <Tooltip title="Dribbble">
                    <Link href="https://dribbble.com/workharu" underline="none" target="_blank" sx={linkSX}>
                ...
                <Grid>
                  <Tooltip title="Youtube">
                    <Link href="https://www.youtube.com/@workharu" underline="none" target="_blank" sx={linkSX}>
