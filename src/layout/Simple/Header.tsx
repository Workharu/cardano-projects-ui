          ...
          <Toolbar sx={{ px: { xs: 1.5, sm: 4, md: 0, lg: 0 }, py: 1 }}>
            ...
            >
              ...
              <Link
                className="header-link"
                color="secondary.main"
                href="https://workharu.gitbook.io/able-pro"
                target="_blank"
                underline="none"
              >
                Documentation
              ...
              <Link href="https://github.com/workharu/able-pro-free-admin-dashboard-template" target="_blank" underline="none">
                <IconButton
                  size="large"
                  shape="rounded"
                  color="secondary"
                ...
                >
                  <List>
                    ...
                    <Link
                      ...
                      href="https://github.com/workharu/able-pro-free-admin-dashboard-template"
                      target="_blank"
                    >
                      <ListItemButton>
                        <ListItemIcon>
                    ...
                    <Link style={{ textDecoration: 'none' }} href="https://workharu.gitbook.io/able-pro" target="_blank">
                      <ListItemButton>
                        <ListItemIcon>
                          <Minus />
                        </ListItemIcon>
                    ...
                    <Link style={{ textDecoration: 'none' }} href="https://workharu.authordesk.app/" target="_blank">
                      <ListItemButton>
                        <ListItemIcon>
                          <Minus />
                        </ListItemIcon>
