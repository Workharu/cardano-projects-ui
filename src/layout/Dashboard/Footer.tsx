                ...
                <Grid container spacing={2}>
                  ...
                  <Grid size={12}>
                    <Typography variant="subtitle1" sx={{ fontWeight: 400, maxWidth: 320 }}>
                      Workharu is trusted by organizations worldwide for delivering high-quality digital solutions. Our experienced team is
                      dedicated to building and managing innovative products that empower businesses to grow.
                    </Typography>
                  </Grid>
                </Grid>
              </motion.div>
                ...
                <Grid size={{ xs: 6, sm: 4 }}>
                  <Stack sx={{ gap: 3 }}>
                    ...
                    <Stack sx={{ gap: { xs: 1.5, md: 2.5 } }}>
                      ...
                      <FooterLink href="https://www.workharu.com" target="_blank" underline="none">
                        Website
                      </FooterLink>
                    </Stack>
                  </Stack>
        ...
        <Container>
          <Grid container spacing={2} sx={{ alignItems: 'center' }}>
            <Grid size={{ xs: 12, sm: 8 }}>
              <Typography>
                © Handcrafted by Team{' '}
                <Link href="https://workharu.com/" target="_blank" underline="none">
                  {' '}
                  Workharu
                </Link>
              </Typography>
